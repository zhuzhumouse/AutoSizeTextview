...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private TextView mAutoSizeTV;
    private LinearLayout mAutosizeLL;
    private TextView mAutoSizeDetails;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAutoSizeTV = (TextView) findViewById(R.id.autosize_tv);
        ...
        mAutoSizeDetails = (TextView) findViewById(R.id.autosize_args_details);
...
//        Log.d(TAG, "autoSizeDefaultEdit:" + autoSizeDefaultEdit.getTextSize());
    ...
    private void resetAllValues() {
        ...
        mAutoSizeTV.setAutoSizeTextTypeWithDefaults(TextView.AUTO_SIZE_TEXT_TYPE_UNIFORM);
        mAutoSizeTV.setAutoSizeTextTypeUniformWithConfiguration(10,100,2,TypedValue.COMPLEX_UNIT_SP);
    }
